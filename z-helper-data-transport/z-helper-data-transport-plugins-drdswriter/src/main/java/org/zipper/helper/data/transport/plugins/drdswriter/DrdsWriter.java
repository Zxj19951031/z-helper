package org.zipper.helper.data.transport.plugins.drdswriter;
...
public class DrdsWriter extends Writer {
    ...
    public static class Job extends Writer.Job {
        ...
        private static final Logger log = LoggerFactory.getLogger(DrdsWriter.Job.class);
    ...
    public static class Task extends Writer.Task {
        private static final Logger log = LoggerFactory.getLogger(DrdsWriter.Task.class);
