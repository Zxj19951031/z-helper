...
public class JsonObject implements Serializable {
    ...
    public static JsonObject from(String json) {
        ...
        try {
            ...
            throw HelperException.newException(JsonError.JSON_PARES_ERROR, e.getMessage());
        }
     ...
     * @throws HelperException 异常
     */
    public Boolean getNecessaryBool(String key, IErrorCode IErrorCode) throws HelperException {
    ...
    public Boolean getBool(final String path) {
        ...
        if (null == result) {
            ...
            throw HelperException.newException(JsonError.CONFIG_ERROR,
